...
urlpatterns = [
    ...
    path('delete-comment/<str:comment_id>/', CommentView.as_view(), name='delete_comment'),
    path('view-comments/<str:post_id>/', CommentView.as_view(), name='view_comments'),

    # toggle like and dislike 
    path('toggle-like/<str:post_id>/', LikesView.as_view(), name='toggele-like'),
